 ...
 */
NMEA_PARSING_RESULT parseUInt32FixedPoint(__in NmeaParsingContext* pContext, __in uint8_t minNumberOfWholeDigits, __in uint8_t maxFractionalDigitsCount, __out uint32_t* pResult);
NMEA_PARSING_RESULT parseUInt16FixedPoint(__in NmeaParsingContext* pContext, __in uint8_t minNumberOfWholeDigits, __in uint8_t maxFractionalDigitsCount, __out uint16_t* pResult);
